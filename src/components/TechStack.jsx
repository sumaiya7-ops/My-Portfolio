...
export default function TechStack() {
  // TypeScript যুক্ত করে সম্পূর্ণ বি-১৩ এক্সপার্ট স্কিলসেট ডেটা
  const stacks = [
    { name: "TypeScript", desc: "Strict type safety systems, custom interfaces, generic components, and scalable code structures.", bg: "bg-blue-50 text-blue-600", icon: "fa-solid fa-code" },
    ...
    { name: "Next.js Framework", desc: "Server-Side Rendering (SSR), App Router hierarchies, and full stack deployment pipelines.", bg: "bg-indigo-50 text-indigo-600", icon: "fa-solid fa-n" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {stacks.map((tech, idx) => (
            <div 
              key={idx} 
              data-aos="fade-up"
              data-aos-delay={idx * 50} // প্রতিটি কার্ড একটার পর একটা স্মুথ মোশনে আসবে
              className="bg-white border border-indigo-50 p-6 flex flex-col justify-between rounded-[2rem] shadow-sm hover:shadow-[0_20px_40px_rgba(99,102,241,0.12)] hover:border-indigo-400 hover:-translate-y-2 transition-all duration-300 cursor-pointer group"
            >
              <div className="space-y-4">
                {/* ফন্ট-অসাম মডার্ন আইকন বাবল */}
