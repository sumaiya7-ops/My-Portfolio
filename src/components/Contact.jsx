...
export default function Contact() {
  ...
  const myInfo = {
    ...
    linkedinUrl: "https://linkedin.com" // আপনার আসল লিংকডইন প্রোফাইল লিঙ্ক
  };
    ...
    <section id="contact" className="w-full px-4 sm:px-6 py-16 sm:py-20 bg-indigo-100 relative z-10 font-['Plus_Jakarta_Sans']">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          {/* বাম কলাম: সোশ্যাল ও ডিরেক্ট কমিউনিকেশন কার্ড (AOS অ্যানিমেশনসহ) */}
          <div className="lg:col-span-5 flex flex-col gap-6 w-full" data-aos="fade-right">
            ...
            {/* ৩. লিংকডইন কার্ড (👑 নতুন ইউআরএল যুক্ত করা হয়েছে) */}
            <div className="bg-white border border-indigo-50 p-6 rounded-[2rem] text-center space-y-4 shadow-sm hover:shadow-[0_20px_40px_rgba(99,102,241,0.08)] hover:-translate-y-1 transition-all duration-300 group cursor-pointer">
              ...
              <div>
                ...
                <span className="block text-sm font-bold text-indigo-950 mt-1">Sumaiya Sorhad</span>
              </div>
          ...
          {/* ডান কলাম: রেসপনসিভ কন্টাক্ট ফর্ম */}
          <div className="lg:col-span-7 flex flex-col gap-6 w-full" data-aos="fade-left">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="bg-white border border-indigo-50/70 p-6 sm:p-8 rounded-[2rem] shadow-sm space-y-5 sm:space-y-6">
              
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider block">Name</label>
                <input type="text" placeholder="Insert your name" className="w-full bg-slate-50 border border-indigo-100 rounded-xl sm:rounded-2xl px-4 py-3.5 sm:px-5 sm:py-4 text-xs sm:text-sm font-medium outline-none focus:border-indigo-500 focus:bg-white transition" />
              </div>

              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider block">Email</label>
                <input type="email" placeholder="Insert your email" className="w-full bg-slate-50 border border-indigo-100 rounded-xl sm:rounded-2xl px-4 py-3.5 sm:px-5 sm:py-4 text-xs sm:text-sm font-medium outline-none focus:border-indigo-500 focus:bg-white transition" />
              </div>

              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider block">Project Summary</label>
                <textarea rows="4" placeholder="Write your project details" className="w-full bg-slate-50 border border-indigo-100 rounded-xl sm:rounded-2xl px-4 py-3.5 sm:px-5 sm:py-4 text-xs sm:text-sm font-medium outline-none focus:border-indigo-500 focus:bg-white transition resize-none"></textarea>
              </div>
